...
proc Misc_PostProcess { srcfile } {
    ...
    # (checking for $pgp(version,$id) is necessary because
    # drafts generated by exmh for PGP key retrieval will not
    # have their own PGP variables set)
    if {$pgp(enabled) && [info exists pgp(version,$id)] && \
